                            ...
                            Form(
                              ...
                              child: Container(
                                ...
                                child: DropdownButtonFormField(
                                  ...
                                  hint: gender == null ? Text('Gender',style: TextStyle(
                                    fontSize: 15.sp,
                                    color: Color(0xff8FD974),
                          ...
                          child: Column(
                            children: [
                              ...
                              DropdownButtonFormField(
                                ...
                                isDense: true,
                                isExpanded: false,
                                hint: club1 == null ? Text('Please select a sports club',style: labelStyle):Text(club1,style: TextStyle(
                                  fontSize: 15.sp,color: Color(0xff8FD974),
                                ),),
                                icon: Icon(
                                  MdiIcons.chevronDown,
                                  color: Color(0xffC5C6C7),
                                ...
                                items: ['No','NJSC', 'Karen tennis', 'Aga khan','Oshwal Centre','Jaffery Turf','Arena One','Gym Khana','Sikh Union','Parklands Sports club','Impala Club'].map(
                                      (val) {
                                    return DropdownMenuItem<String>(
                                      value: val,
                                      child: Text(val),
                              ...
                              DropdownButtonFormField(
                                ...
                                isDense: true,
                                isExpanded: false,
                                hint: club2 == null ? Text('Please select a sports club',style: labelStyle):Text(club2,style: TextStyle(
                                  fontSize: 15.sp,color: Color(0xff8FD974),
                                ),),
                                icon: Icon(
                                  MdiIcons.chevronDown,
                              ...
                              DropdownButtonFormField(
                                ...
                                isDense: true,
                                isExpanded: false,
                                hint: club3 == null ? Text('Please select a sports club',style: labelStyle):Text(club3,style: TextStyle(
                                  fontSize: 15.sp,color: Color(0xff8FD974),
                                ),),
                                icon: Icon(
                                  MdiIcons.chevronDown,
  ...
  createUserProfile() async {
    try {
      await locator.get<UserController>()
          .uploadProfile(age: age,clubC: club3,clubB: club2,clubA: club1,coach: coach,buddy: buddy,gender: gender,pasteUrl: pasteUrl.text);
      print("Age:"+age);
